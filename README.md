...
`apps/api/src/feishu-notification/skill-payment-success.v1.json`，并校验文件
SHA-256。模板不包含 webhook、签名密钥、买家身份或下载链接。

```yaml
- uses: Dogtiti/feishu-bot-webhook-action@<包含此卡片的提交 SHA>
  with:
    mode: skill-payment
